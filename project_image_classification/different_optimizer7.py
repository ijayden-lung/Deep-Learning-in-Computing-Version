...
(model,history) = train_model(model_ft, criterion, optimizer, num_epochs=25, save_path='saved_weight.mynet4_7drop')
# TODO Task 2:  Test the model
test_model(model_ft, load_path='saved_weight.mynet4_7drop')
